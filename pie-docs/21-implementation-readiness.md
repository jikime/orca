...
| 화상회의·회의록         | 실행 수직·계약 초안 | `08`, `35`, meeting schema·vertical | transcript segment, 업무 전환, consent·retention, 다자간 E2E |
| 원격지원·원격 데스크톱  | 계약 초안           | `07`, `34`, `ADR-0011`              | Relay·capability 수직과 원격 데스크톱 엔진 prototype         |
