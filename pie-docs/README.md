...
| [메시지 거버넌스와 모더레이션](./33-message-governance-moderation.md)                | 메시지 수정·삭제·고정과 WorkItem 전환 후속 에픽                                   |
| [실시간 협업 터미널과 Relay](./34-collaborative-terminal-relay.md)                   | 다중 참여자 터미널, capability, Relay와 E2EE 단계                                 |
| [회의·회의록 제품 로드맵](./35-meeting-product-roadmap.md)                           | 현재 회의 구현, 상세 도메인 초안, 단계별 backlog와 완료 gate                      |
| [채팅 핵심 제품 로드맵](./36-chat-core-roadmap.md)                                   | Slack 핵심만 남긴 채팅 범위, 현재 공백, 순차 backlog와 완료 gate                  |
| [채팅 릴리스 검증 기록](./37-chat-release-evidence.md)                               | 초안·재시도·안 읽음·가상화·거버넌스의 사용자 흐름과 자동화 gate                   |
| [회의록 생산성 보류 설계](./38-meeting-minutes-productivity-deferred.md)             | 보류한 M6 범위, 재개 순서, 보안·권한 gate와 재개 조건                             |
| [프로젝트·작업·Workspace 통합](./39-project-workspace-integration.md)                | 단순화한 업무 포털 IA, 내부 WorkItem 실행 문맥과 단계별 구현 순서                 |
| [외부 업무 연동 TODO](./40-external-work-integration-todo.md)                        | 보류한 GitHub·GitLab·Linear·Jira issue 연결 범위, 재개 순서와 검증 gate           |
| [프로젝트 작업면 기능 가이드](./41-project-workspace-feature-guide.md)               | 현재 프로젝트 개요, 생성·편집 Dialog, API·동시성과 검증 범위                      |
