...
export function registerNotificationHandlers(store: Store, runtime?: OrcaRuntimeService): void {
  ...
  ipcMain.handle(
    ...
    (
      ...
      // Why: Pie notifications use desktop-only navigation contracts; mobile dispatch currently accepts terminal sources only.
      ...
      function deliverNativeNotification():
        ...
        // Why: Pie notifications route to their own surface before the generic worktree navigation path.
